...
%\title{Bed level and mean grain size dynamics on a steep mixed sand-gravel beach}
...
\author[label1]{Tristan B. Guest\corref{cor1}}
\cortext[cor1]{Corresponding author.}
\ead{tristan.guest@dal.ca}
\author[label1]{Alex E. Hay}
\address[label1]{{Department of Oceanography, Dalhousie University, Halifax, Nova Scotia, B3H 4R2, Canada}}

%\author{Tristan B. P. Guest}
...
%%Research highlights
\begin{highlights}
\item Surficial fining of beach sediments corresponded to energetic wave forcing
\item Changes in bed level and mean grain size are spatially correlated throughout the intertidal zone

\end{highlights}

\begin{keyword}
%% keywords here, in the form: keyword \sep keyword
morphodynamics \sep mean grain size \sep grain size segregation \sep swash zone
...
%The field site is Advocate Beach, Nova Scotia, Canada. The site is positioned near the head of the Bay of Fundy, and therefore experiences a large tide range of 8 to 12 m. 


\begin{figure}[tbp] %/home/tristan/Documents/Projects/AdvocateBeach2018/src/visualization/plot_beach_profile_data.py
	\includegraphics[width=\columnwidth]{figures/chapter3/Advocate_map_with_inset.png}
